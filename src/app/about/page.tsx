export default function About() {
    ...
    return (
        <div className="lg:px-32 px-6 py-10 pb-20 space-y-6 text-gray-800">
            {/* Intro */}
            ...
            <section className="flex justify-between flex-col-reverse gap-3 text-justify md:flex-row md:gap-30 items-start w-full">
